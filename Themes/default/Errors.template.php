	...
	foreach ($context['errors'] as $error)
	{
		...
		echo '
				...
				<div class="post">
					...
					<div class="codeheader"><span class="code floatleft">' . $txt['error_message'] . '</span> <button type="button" class="link-btn codeoperation smf_select_text">' . $txt['code_select'] . '</button> <button type="button" class="link-btn codeoperation smf_expand_code hidden" data-shrink-txt="' . $txt['code_shrink'] . '" data-expand-txt="' . $txt['code_expand'] . '">' . $txt['code_expand'] . '</button>
